...
docker pull 864899871537.dkr.ecr.eu-north-1.amazonaws.com/emotion-project-ecr:latest
...
docker run -d -p 80:5000 -e DAGSHUB_PAT=157747ed9e1f44d43b983f67bfb36c12e07602e5 --name campusx-app 864899871537.dkr.ecr.eu-north-1.amazonaws.com/emotion-project-ecr:latest